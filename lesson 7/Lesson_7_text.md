...
Давайте реализуем наш класс Cat. Для этого после ключевого слова class.
...
му является переменной класса. Переменная name, work_mode принадлежат объекту (им
